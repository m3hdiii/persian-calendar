...
public class Bagger extends Object {
    ...
    public Integer getIPadX() {
        if (iPadX == null) iPadX = new Integer(0);
        return iPadX;
    }
    ...
    public Integer getIPadY() {
        if (iPadY == null) iPadY = new Integer(0);
        return iPadY;
    }
    ...
    public Insets getInsets() {
        if (insets == null) insets = new Insets(1, 1, 1, 1);
        return insets;
    }
    ...
    public Integer getAnchor() {
        if (anchor == null) anchor = FIRST_LINE_START;
        return anchor;
    }
    ...
    public void setJPanel(JPanel jPanel) {
        this.jPanel = jPanel;
        if (!(jPanel.getLayout() instanceof GridBagLayout)) jPanel.setLayout(new GridBagLayout());
    }

    public JPanel getJPanel() {
        if (jPanel == null) setJPanel(new JPanel());
        return jPanel;
    }
